...
export default {
  en:{
    ...
    mtGas:"Gas",
    mtTemp:"Temperature",
    mtBenchHelp:"Drag the temperature. Water freezes at 0°C and boils at 100°C — watch what the particles do at each one.",
    ...
    mtAtFreeze:"0°C — freezing and melting point",
    mtAtBoil:"100°C — boiling point",
    ...
    arcHowMt:"Things drop from the top. Send each one to the jar for its state before it reaches the bottom.",
    ruleMtGood:"Right jar — 300 points and 1 extra second",
  ...
  vi:{
    ...
    mtGas:"Chất khí",
    mtTemp:"Nhiệt độ",
    mtBenchHelp:"Kéo thanh nhiệt độ. Nước đông đặc ở 0°C và sôi ở 100°C — hãy xem các hạt làm gì ở mỗi mốc.",
    ...
    mtAtFreeze:"0°C — điểm đông đặc và nóng chảy",
    mtAtBoil:"100°C — điểm sôi",
    ...
    arcHowMt:"Đồ vật rơi từ trên xuống. Hãy đưa mỗi thứ vào lọ đúng thể của nó trước khi chạm đáy.",
    ruleMtGood:"Đúng lọ — 300 điểm và thêm 1 giây",
